    ...
    public boolean insertar(Profesor profesor, String matricula, String correo)
    {
        ...
        try
        {
            ...
            try (PreparedStatement psUsuario = conn.prepareStatement(sqlUsuario, Statement.RETURN_GENERATED_KEYS))
            {
                ...
                // Contraseña temporal = matrícula, hasheada igual que en SRegistrarUsuario.
                // RequiereCambioContrasena=1 obliga a cambiarla en el primer login.
                psUsuario.setString(6, PasswordUtil.hashear(matricula));
